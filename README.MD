...
- **Future:** Google Analytics may be added for usage metrics (page views, device types)

### Security

- **Read-only** — The application only displays data; it cannot modify ArcGIS or Google Sheets
